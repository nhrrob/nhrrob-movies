...
<div class="wrap">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="<?php echo e(admin_url('admin.php?page=nhrrob-movies-create')); ?>" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
        ...
        <tbody>
            ...
            <tr class="hover:bg-gray-100">
                ...
                <td class="py-2 px-4 border-b text-right">
                    ...
                    <a href="<?php echo e(admin_url('admin-post.php?action=nhrrob_movies_delete&id=' . $movie->id . '&nhrrob_movies_nonce=' . wp_create_nonce('nhrrob_movies_delete_nonce'))); ?>" class="text-red-600 hover:underline ml-4"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/robinwpdeveloper/Sites/nhrrob-dev/wp-content/plugins/nhrrob-movies/app/Views/admin/movies-index.blade.php ENDPATH**/ ?>