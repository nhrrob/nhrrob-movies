...
<div class="wrap max-w-2xl mx-auto">
    ...
    <form method="post" action="<?php echo e(admin_url('admin-post.php')); ?>" class="bg-white p-6 rounded-lg shadow-md">
        <input type="hidden" name="action" value="nhrrob_movies_store">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/robinwpdeveloper/Sites/nhrrob-dev/wp-content/plugins/nhrrob-movies/resources/views/admin/movie/create.blade.php ENDPATH**/ ?>